...
public class CityDao extends AbstractDao<City, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property ShortPinyin = new Property(4, String.class, "shortPinyin", false, "SHORT_PINYIN");
        public final static Property LastUseTime = new Property(5, Long.class, "lastUseTime", false, "LAST_USE_TIME");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CITY\" (" + //
                ...
                "\"SHORT_PINYIN\" TEXT NOT NULL ," + // 4: shortPinyin
                "\"LAST_USE_TIME\" INTEGER);"); // 5: lastUseTime
    }
    ...
    protected void bindValues(SQLiteStatement stmt, City entity) {
        ...
        stmt.bindString(5, entity.getShortPinyin());
 
        Long lastUseTime = entity.getLastUseTime();
        if (lastUseTime != null) {
            stmt.bindLong(6, lastUseTime);
        }
    }
    ...
    public City readEntity(Cursor cursor, int offset) {
        City entity = new City( //
            ...
            cursor.getString(offset + 4), // shortPinyin
            cursor.isNull(offset + 5) ? null : cursor.getLong(offset + 5) // lastUseTime
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, City entity, int offset) {
        ...
        entity.setShortPinyin(cursor.getString(offset + 4));
        entity.setLastUseTime(cursor.isNull(offset + 5) ? null : cursor.getLong(offset + 5));
     }
