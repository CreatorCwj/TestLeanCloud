...
@ContentView(R.layout.activity_scroll_and_hide)
public class ScrollAndHideActivity extends BaseActivity implements RLRView.OnRefreshListener, RLRView.OnLoadListener {
...
//        loadMoreView.addData(MockData.getImageUrls(0, 15));
    }
        ...
        new Network<>(this, GirlImage.class)
                ...
                .setRequestCallback(new RequestCallback<GirlImage>() {
                    ...
                    public void onRequestError(String errorMessage) {
                        Utils.showToast(ScrollAndHideActivity.this, errorMessage);
                        rlrView.rlError();
                    }
